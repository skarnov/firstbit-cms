<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url(); ?>super_admin/manage_coupon"> Manage Coupon</a></li>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form action="<?php echo base_url(); ?>super_admin/update_coupon" name="coupon" method="POST">
                        ...
                        <div class="col-xs-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="coupon_amount" value="<?php echo $coupon_info->coupon_amount; ?>" class="form-control">
                                </div>
                                <div class="form-group">
