        ...
        <div class="row">
            <div class="col-md-12">
                <h3 style="color:green">
                    <?php
                    $msg = $this->session->userdata('save_trip');
                    if (isset($msg)) {
                        echo $msg;
                        $this->session->unset_userdata('save_trip');
                    }
                    ?>
                </h3>
                <form action="<?php echo base_url(); ?>eticket_admin/save_trip" method="POST">
                        ...
                        <div class="col-xs-6">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ticket_old_price" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="trip_date" value="<?php echo date('d/m/Y'); ?>" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Departure Time</label>
                                    <input type="text" name="trip_time" value="<?php date_default_timezone_set('Asia/Dhaka'); echo date("g.i A", time());?>" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Arrival Time</label>
                                    <input type="text" name="trip_arrival_time" value="<?php echo date("g.i A", time());?>" class="form-control">
                                </div>
                            </div>
                        </div>
