<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url(); ?>eticket_admin/sales_report"> Search Sales Report</a></li>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="col-xs-12">
                            <div class="box-body">
                                <div class="col-xs-1">
                                    <a href="<?php echo base_url(); ?>eticket_admin/download_sales_report/<?php echo $start ?>/<?php echo $end ?>" class="btn btn-success">Download PDF</a>
                                </div>
                                <div class="col-xs-12">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($sales_report as $v_info) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $v_info->customer_name; ?></td>
