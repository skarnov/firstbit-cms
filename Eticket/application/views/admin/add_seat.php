...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add New Seat Plan</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 style="color:green">
                    <?php
                    $msg = $this->session->userdata('save_seat');
                    if (isset($msg)) {
                        echo $msg;
                        $this->session->unset_userdata('save_seat');
                    }
                    ?>
                </h3>
                <form action="<?php echo base_url(); ?>eticket_admin/save_seat" method="POST">
                    <div class="col-xs-3">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="seat_name" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Seat Row</label>
                                <input type="text" name="seat_row" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Seat Column</label>
                                <input type="text" name="seat_column" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-offset-2 col-xs-3" style="box-shadow: 0px 0px 10px red; margin-top: 2%;">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-xs-1">
                                    <label>H2</label>
                                    <input type="checkbox" name="h2" value="1">
                                </div>
                                <div class="form-group col-xs-offset-1 col-xs-1">
                                    <label>H3</label>
